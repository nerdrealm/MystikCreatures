document.addEventListener("DOMContentLoaded", function() {
  ...
  const footerContent = `
    <footer style="margin-top:4rem; padding:1.5rem; border-top:1px solid #1a202c; text-align:center; font-size:0.75rem; color:#a0aec0;">
      <p>&copy; 2026 <strong>Mystik Creatures™ TCG</strong>. All Rights Reserved.</p>
    </footer>
  `;
